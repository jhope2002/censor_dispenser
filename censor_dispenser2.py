...
phrases_to_censor = ['learning algorithms', "she", "personality matrix", "sense of self", "self-preservation", "learning algorithm", "her", "herself"]

punctuation = ['.', '!', ":", ";", "\""]

def censor_email(email_to_censor, phrases=None):
